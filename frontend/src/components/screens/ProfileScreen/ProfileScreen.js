...
function ProfileScreen() {
  ...
  // THIS WILL RUN FIRST
  // 1. CHECKS THE userInfo IF THE USER IS LOGGED IN, IF NOT REDIRECT
  // 2. IF YES, THEN DISPATCH AN ACTION THAT WILL GET USER DETAILS
  // Notes:
  // THIS useEffect WILL ONLY RUN ONCE AFTER THE PROFILE SCREEN COMPONENT LOAD.
  ...
  // THEN THIS WILL RUN SECOND
  // 1. WE GET THE OBJECT 'user' FROM THE userInfo
  // 2. WE THEN SET THE FORM FIELD'S VALUES TO WHAT WE HAVE GET.
