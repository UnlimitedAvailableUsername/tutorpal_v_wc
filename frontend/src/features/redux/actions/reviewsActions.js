...
export const listReviewsOfTutor = (tutorId) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(`${BASE_URL}/api/accounts/reviews/tutors/${tutorId}/`);
...
export const getReviewDetails = (reviewId) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(`${BASE_URL}/api/accounts/reviews/${reviewId}/`);
...
export const addReview = (formData) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.post(`${BASE_URL}/api/accounts/reviews/create/`, formData, config);
...
export const editThisReview = (reviewId, formData) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.put(`${BASE_URL}/api/accounts/reviews/${reviewId}/`, formData, config);
